...
<!--<div class="id-card-tag"></div>
   ...
   <div class="id-card-holder">-->
    ...
    left: 0.50in;
    width: auto;
    height: 1.14in;" src="IDcard/ci_2.png" />
	   ...
	   <img style="top:2.01in;left:1.25in;width:1.10in;" src="<?php echo $row['mem_image']; ?>" />
	   </div>
	   ...
	   <div style="background-color: #87CEEB; height: 80px; width: 244px; border-radius: 100% 0px 0px 0px; border-top: 3px solid navy; bottom: 190px; left: 43px; position: absolute;">
		   <div style="position:absolute;top:25px;left:65px;">
			  <h3 style="color:#000080;"><strong>Membership No : <?php echo $nrna_id; ?> </strong></h3>
