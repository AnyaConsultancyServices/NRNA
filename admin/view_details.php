            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> All Family Members </a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">All Family Members</h4>
                                </div>
...
<th>ID Card</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="view_member.php?id=<?php echo $row['member_id']; ?>">View</a></td>
<td><a href="../create-id.php?id=<?php echo $row['member_id']; ?>">Create</a></td>
                                            </tr>
                                            <?php } ?>
...
<?php while ($familyrow = $familymebers->fetch(PDO::FETCH_ASSOC)) { ?>
                                            <tr>
                                                ...
                                                <td><a href="view_member.php?id=<?php echo $familyrow['member_id']; ?>">View</a></td>
<td><a href="../create-id.php?id=<?php echo $familyrow['member_id']; ?>">Create</a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
