               ...
               <div id="msform">
                  ...
                  <fieldset>
                     ...
                     <select id="contact_code" name="contact_code" style="width: 20%; margin-right: 1%; float: left; padding: 15px 2px 15px 8px;">
                     	<option value="44" selected="selected">+44</option> <option value="91">+91</option><option value="977">+977</option>
                     </select>
                     ...
                     <table id="familytable" class="table table-bordered">
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <input type="date" class="datepicker" name="mem_dob[]" value="" required="required" autocomplete="off">
                              </td>
                              <td>
...
<form action="<?php echo $paypal_url; ?>" method="post" name="nrnaForm">
    ...
    <input type='hidden' name='cancel_return' value='http://nrna.co.uk/dev/pp_cancel.php'>
